        ...
        <div className='container p-3'>
            <div className='row p-5'>
                <div className='col-6 p-5'>
                    ...
                    <p className='text-muted'>No gimmicks, spam, "gamification", or anoyingb push notification. High quality apps that you use at your pace, the way you like</p>
                    ...
                    <p className='text-muted'>With initiatives like Nudge and kill Seith, we don't just facilitate transations, but actively help you do better with your money</p>
                </div>
                <div className='col-6 p-5'>
